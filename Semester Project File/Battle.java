...
public class Battle
{
    ...
    private void enemyPhase()
    {
        ...
        {
            JOptionPane.showMessageDialog(null, enemyName + " is " + statusEffect.getEnemyStatusEffect() + "!\nThey cannot move this turn.", statusEffect.getEnemyStatusEffect(), JOptionPane.INFORMATION_MESSAGE);
            statusEffect.iterateTurn("Enemy");
            if(!friendlyBattle)
            {
                if(ally.getHP() > 0)
                {
        ...
        String message = "";
        //the ally iterates their status effect turn first before moving, so status effects
        //can take place before acting.
        message += statusEffect.iterateTurn("Enemy");
        ...
        if(randomNum == 0)
        {
            ...
            if (skillStatusEffect.equals("Drain")) {
                ...
                {
                    System.out.println(enemyName + " drained " + drainAmount + "HP from " + heroStats.getHeroName() + "!");
                    message += "\n\n" + enemyName + " drained " + drainAmount + "HP from " + heroStats.getHeroName() + "!";
                    message += "\n" + enemyName + " now has " + enemy.getEnemyHP() + "HP / " + enemy.getEnemyMaxHP() + "HP.";
                }
            }
            else
            {
                message += "\n" + statusEffectProc(skillStatusEffect, "Enemy", "Hero", skillStatusEffectProc, skillStatusEfficacy, skillStatusLength);
            }
        }
        else //Attack Ally
        {
            ...
            if (skillStatusEffect.equals("Drain")) {
                int drainAmount = statusEffect.drain("Enemy", afterSkillDamage, skillStatusEffectProc);
                {
                    System.out.println(enemyName + " drained " + drainAmount + "HP from " + ally.getAllyName() + "!");
                    message += "\n\n" + enemyName + " drained " + drainAmount + "HP from " + ally.getAllyName() + "!";
                    message += "\n" + enemyName + " now has " + enemy.getEnemyHP() + "HP / " + enemy.getEnemyMaxHP() + "HP.";
                }
            }
            else
            {
                message += "\n" + statusEffectProc(skillStatusEffect, "Enemy", "Ally", skillStatusEffectProc, skillStatusEfficacy, skillStatusLength);
            }
        }
    ...
    private void heroPhase()
    {
        if (statusEffect.getHeroStatusEffect().equalsIgnoreCase("Frozen")
            ...
            JOptionPane.showMessageDialog(null,
                    ...
                    statusEffect.getHeroStatusEffect(), JOptionPane.INFORMATION_MESSAGE);
            statusEffect.iterateTurn("Hero");
            battleTurn = "Enemy";
            return;
        }
        //message stores events that have happened this phase.
        String message = "";
        //the hero iterates their status effect turn first before moving, so status effects
        //can take place before acting.
        message += statusEffect.iterateTurn("Hero");

        do
        {
            //Menu options for the Hero Phase.
            String[] commands = { "Attribute Info", "Hero Attributes", "Skills", "Skill Damage",
            ...
            optionChosen = JOptionPane.showOptionDialog(null, "What is " + heroStats.getHeroName() + " going to do?\n\n(" + statusEffect.getHeroStatusEffect() + ")   Hero HP:        " + heroStats.getHP() + "HP / " + heroStats.getMaxHP() + "HP\n(" + statusEffect.getAllyStatusEffect() + ")   Ally HP:          " + ally.getHP() + "HP / " + ally.getMaxHP() + "HP\n(" + statusEffect.getEnemyStatusEffect() + ")   Enemy HP:    " + enemy.getEnemyHP() + "HP / " + enemy.getEnemyMaxHP() + "HP", "Hero Phase", JOptionPane.DEFAULT_OPTION,
                    JOptionPane.INFORMATION_MESSAGE, null, commands, commands[8]);
            }
            else //Friendly Battle
            {
                //This optionChosen does not show ally HP since it would be null.
            optionChosen = JOptionPane.showOptionDialog(null, "What is " + heroStats.getHeroName() + " going to do?\n\n(" + statusEffect.getHeroStatusEffect() + ")   Hero HP:        " + heroStats.getHP() + "HP / " + heroStats.getMaxHP() + "HP\n(" + statusEffect.getEnemyStatusEffect() + ")   Enemy HP:    " + enemy.getEnemyHP() + "HP / " + enemy.getEnemyMaxHP() + "HP", "Hero Phase", JOptionPane.DEFAULT_OPTION,
                    JOptionPane.INFORMATION_MESSAGE, null, commands, commands[8]);
            }
            ...
            if (optionChosen == 0)
            {
                JOptionPane.showMessageDialog(null, heroStats.attributeDescription(skillTree.getHeroClass()),
                        "Attribute Description", JOptionPane.INFORMATION_MESSAGE);
            }
            //Hero Attributes - Show Hero's Current Attributes
            else if (optionChosen == 1)
            {
                JOptionPane.showMessageDialog(null, heroStats.listAttributes(), "Hero Attributes",
            ...
            else if (optionChosen == 2)
            {
                if(ally != null)
                {
                    JOptionPane.showMessageDialog(null, heroName + "\n_________\n" + skillTree.getHeroSkills() + "\n__________\n" + allyName + "\n__________\n" + ally.getAllySkills(), "Skills",
                        JOptionPane.INFORMATION_MESSAGE);
                }
                else
                {
                    JOptionPane.showMessageDialog(null, heroName + "\n_________\n" + skillTree.getHeroSkills() + "\n__________\n", "Skills", JOptionPane.INFORMATION_MESSAGE);
                }
            ...
            else if (optionChosen == 8)
            {
                ...
                if(skillChoice != -1)
                {
                    ...
                    {
                        message += statusEffectProc(skillStatusEffect, "Hero", "Enemy", skillStatusEffectProc, skillStatusEfficacy, skillStatusLength);
                    }
    ...
    private void allyPhase()
    {
        ...
        //the ally iterates their status effect turn first before moving, so status effects
        //can take place before acting.
        message += statusEffect.iterateTurn("Ally");
        ...
        {
            message += "\n" + statusEffectProc(skillStatusEffect, "Ally", "Enemy", skillStatusEffectProc, skillStatusEfficacy, skillStatusLength);
        }
    ...
    private String statusEffectProc(String effect, String caster, String who, int proc, int efficacy, int length)
    {
        ...
        if (effect.equals("Bleed")) {
            if (!statusEffect.bleed(who, efficacy, proc, length)) {
                System.out.println(caster + " failed to Bleed " + who + "!");
                message = "\n" + caster + " failed to Bleed " + who + "!";
        ...
        if (effect.equals("Submission")) {
            ...
            {
                message = who + " couldn't resist the vicious attack!";
            }
        }
