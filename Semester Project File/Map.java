    ...
    private void advanceScenario(String scenario)
    {
        ...
        if (scenario.equals("Boss Battle"))
        {
            ...
            if (area == 10) {
                ...
                //{
                    ...
                    Enemy knight = new Enemy("Legion Royal Guard");
        ...
        else if (area == 20)
        {
                ...
                //{
                    ...
                    //Creates a new Enemy and allows the user to battle the enemy.
                    Enemy bowmen = new Enemy("Cavalry Squad Leader");
            ...
            else if (area == 40)
            {
                ...
                //{
                    ...
                    //Creates a new Enemy and allows the user to battle the enemy.
                    Enemy shadow = new Enemy("Shadow Ruler");
            ...
            else if (area == 50)
            {
                ...
                //{
                    ...
                    //Creates a new Enemy and allows the user to battle the enemy.
                    Enemy robertz = new Enemy("Robertz");
            ...
            else if(area == 60)
            {
                ...
                try
                {
                    ...
                    //{
                        ...
                        //Creates a new Enemy and allows the user to battle the enemy.
                        Enemy leaderLegion = new Enemy("Leader of the Legion");
                        ...
                        else
                        {
                            ...
                            String[] option2 = {"I will as well."};
                            JOptionPane.showOptionDialog(null, "\"Agreed,\" Anthiera says, \"as a Royal Guard member, I will assist in any way I can.\"", "Epilogue", JOptionPane.YES_NO_OPTION, JOptionPane.INFORMATION_MESSAGE, null, option2, option2[0]);

                            //Credits
                            JOptionPane.showMessageDialog(null, "Thank you for playing Dungeon of Dystopia!\n\nCredits:\nCoding: Michael Ng\nWriting: Michael Ng\nDesign: Michael Ng\nPlanning: Michael Ng\nDirector: Michael Ng\n(Note: Yes, I created this entire project. I had too much fun coding and debugging.)", "Game Credits", JOptionPane.DEFAULT_OPTION);
                            //Music Credits
        ...
        if(scenario.equals("Random Event"))
        {
            ...
            if(randomNum == 5)
            {
                ...
                message += "\n" + heroStats.getHeroName() + " looks, but the sound appears to originate on the other side of a wall.";
                message += "\n" + heroStats.getHeroName() + " listens. They can hear \"I am asking once again for Financial Support\"\n";
                
                if(heroStats.getMoney() >= 10)
                {
                    message += heroStats.getHeroName() + " notices a coin slot. They slip in some money and walk away.";
                    message += "\nmaxHP increased by 20 at the cost of $10!";

                    JOptionPane.showMessageDialog(null, message, "Financial Support", JOptionPane.INFORMATION_MESSAGE);
                    heroStats.addMaxHP(20);
                    heroStats.addMoney(-10);
                }
                else
                {
                    message += heroStats.getHeroName() + " could not afford to give financial support.";
                    message += "\nAs " + heroStats.getHeroName() + " turns away, the wall suddenly breaks down, revealing a man wearing simple clothes, with socks and sandals.";
        ...
        if(scenario.equals("Encounter"))
        {
            ...
            Driver.stopAudio();
            Enemy anthiera = new Enemy("Anthiera");
