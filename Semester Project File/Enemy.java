...
public class Enemy
{
    ...
    public Enemy(int area)
    {
        ...
        if (randomNum == 13) {
            ...
            enemySkillDescriptions[1] = "Poke: The Centipede jabs the target with a leg. Not so effective. Deals damage equal to constitution * 2.";
            skillStatusEffect[0] = "50 Stun 0 2";
            skillStatusEffect[1] = "0 None 0 0";
            enemySkillDamage[0] = 0;
            enemySkillDamage[1] = enemyConstitution * 2;
    ...
    public Enemy(String enemy)
    {
        ...
        if(enemy.equals("Cavalry Squad Leader"))
        {
            ...
            enemyDescription = "The Leader and his men are on horseback with bow and arrows, and man will they hurt";
            enemyHP = 500;
            enemyMaxHP = enemyHP;
            enemyConstitution = 25;
            enemyAffinity = 0;
        ...
        if(enemy.equals("Reaper"))
        {
            ...
            enemySkills[0] = "Reap";
            enemySkills[1] = "Haunt";
            enemySkillDescriptions[0] = "Reap: Slice the target with a sharp Scythe. Bleed the target for 30HP every turn for 5 turns.";
            enemySkillDescriptions[1] = "Haunt: Spook the target, rendering them unable to fight. 70% chance to Pacify the target for 2 turns.";
            //This formatting represents: Proc Chance, Status Effect, Efficacy, Effect Duration
            skillStatusEffect[0] = "100 Bleed 30 5";
            skillStatusEffect[1] = "70 Pacify 0 2";
            enemySkillDamage[0] = 0;
            enemySkillDamage[1] = 0;
        }
        //Boss 4 - Shadow Ruler
        ...
        if(enemy.equals("Leader of the Legion"))
        {
            ...
            enemyDescription = "The Final Boss, who wields Thyrfig. Defeat him and liberate the human race from oppression!";
            enemyHP = 10000;
            enemyMaxHP = enemyHP;
            enemyConstitution = 150;
            enemyAffinity = 0;
            enemySpeed = 30;
            enemyXPAward = 100;
            ...
            enemySkillDescriptions[1] = "Decimate: Brings down Thyrfig upon the target with great might, much like an excecutioner's. Deals damage equal to Constitution with a 40% chance to Sunder the target, reducing their armor by 20 for 3 turns.";
            //This formatting represents: Proc Chance, Status Effect, Efficacy, Effect Duration
